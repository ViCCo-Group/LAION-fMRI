...
`)+`
`+d);let A=T+p+a,b=T+d+o,w=gc(s,s.VERTEX_SHADER,A),E=gc(s,s.FRAGMENT_SHADER,b);s.attachShader(v,w),s.attachShader(v,E),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function R(P){if(i.debug.checkShaderErrors){let G=s.getProgramInfoLog(v)||"",z=s.getShaderInfoLog(w)||"",W=s.getShaderInfoLog(E)||"",Y=G.trim(),k=z.trim(),B=W.trim(),Z=!0,he=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,w,E);else{let ae=xc(s,w,"vertex"),ue=xc(s,E,"fragment");Te("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
